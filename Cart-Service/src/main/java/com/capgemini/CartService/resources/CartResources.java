...
public class CartResources {
	...
	public ResponseEntity<Cart> updateCart(@RequestBody Cart cart) {
		...
		Set<FoodProducts> items = updateCart.getProducts();					//Items present in cart	
		Set<FoodProducts> newItemsToAdd = cart.getProducts();			//Items to add into cart		
		Iterator<FoodProducts> itr = newItemsToAdd.iterator();
		while(itr.hasNext())
		{
			items.add(itr.next());
		}
